...
class Company():
    ...
    def menu(self):
        ...
        print("<td><a href = {0}?student={1}&action=2&index={2}> Добавить сотрудника</a></td>".format(self.selfurl, self.q['student'].value,"8"))
        print("<td><a href = {0}?student={1}&action=3&index={2}> Добавить разработчика</a></td>".format(self.selfurl, self.q['student'].value,"8"))
